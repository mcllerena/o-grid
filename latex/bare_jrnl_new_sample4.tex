...
\begin{abstract}
	...
	Brazilian Interconnected Power System (BIPS). The formulation combines detailed AC network physics
	...
	controller equations are represented with bounded soft constraints so the model remains feasible under
	stressed operating conditions. The implementation is developed in Python using Pyomo and solved with
	Ipopt. Validation against the Brazilian software Anarede on equivalent planning and operational BIPS
