...
\begin{IEEEkeywords}
	AC/DC power flow, large-scale power systems, line-commutated converter, nonlinear programming, 
	open-source software, static var compensator, thyristor-controlled series capacitor, FACTS,
...
comparison explicit, Figure~\ref{fig:equivalent_bips_model_ac_components} and \ref{fig:equivalent_bips_model_dc_components}
...
For large-scale snapshots, Figure~\ref{fig:bus_validation} shows that bus and generation profiles remain inside operational ranges and support the expected stressed-transfer behavior.
Transformer taps and converter controls stay within limits, and FACTS/LCC formulations maintain feasible operation without saturation.
